 ...
 * Provides methods to compress files and encode them for UDP transmission
 */
public class FileTransfer {
    public static final int CHUNK_SIZE = 400; // 400 bytes per chunk for safe UDP transmission
